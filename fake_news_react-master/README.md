...
This is a collaboration project between myself and  who built the API from which the stories are derived.  Find the full documentation for the [Fake News API here](https://github.com/Josep1992/fake_news_api_express).
